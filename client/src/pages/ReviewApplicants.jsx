...
import { ArrowLeft, Building2, MapPin, Briefcase, Crown, Users } from 'lucide-react';
        ...
        <div className="flex justify-between items-start">
          <div>
            ...
            <p className="text-muted-foreground max-w-2xl">
              Find the perfect match for your job opening. Review applicants and choose the best fit by swiping right to accept or left to reject.
            </p>
          </div>
